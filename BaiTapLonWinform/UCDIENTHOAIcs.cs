...
{
    public partial class UCDIENTHOAIcs : UserControl
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            tbgiaban.Text = dataGridView1.SelectedRows[0].Cells[3].Value.ToString();

        }

        private void UCDIENTHOAIcs_Load(object sender, EventArgs e)
        {
            LoadNhomhang();
            dataGridView1.DataSource = modify.getAllData(query);
        }
